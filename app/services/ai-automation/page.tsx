...
export default function AIAutomation() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-electricblue selection:text-white pb-0">
      ...
      {/* Solutions */}
      <section id="solutions" className="py-24 md:py-32 px-4 max-w-7xl mx-auto text-center border-b-[4px] border-white/10 pb-32">
        <h2 className="font-display font-black text-4xl md:text-6xl leading-tight uppercase tracking-tighter mb-16 max-w-4xl mx-auto">
          We build systems that work <span className="text-electricblue">even when you&apos;re busy.</span>
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {solutions.map((item, i) => (
            <div key={item} className="bg-[#111] border-[2px] border-white/20 rounded-2xl p-6 font-bold uppercase text-sm md:text-base hover:border-lime transition-colors text-center shadow-[4px_4px_0_0_#000]">
              {item}
            </div>
          ))}
        </div>
      ...
      {/* Types Section */}
      <section className="bg-lime text-black py-24 md:py-32 px-4 border-y-[4px] border-black">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-display font-black text-5xl md:text-7xl uppercase tracking-tighter mb-16 text-center text-black">What can be automated?</h2>
          <div className="flex flex-wrap justify-center gap-4">
            {types.map((type, i) => (
              <motion.div key={i} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-white border-[3px] border-black px-8 py-4 rounded-full shadow-[4px_4px_0_0_#000] font-bold text-lg uppercase flex items-center justify-center transform hover:-translate-y-1 transition-transform">
                {type}
              </motion.div>
            ))}
          </div>
